...
function simpleSearch(items: any[], query: string): any[] {
  ...
  console.log('🔍 Filter debug:', {
    array: items,
    arrayType: typeof items,
    isArray: Array.isArray(items),
    location: 'ContractsListPage simpleSearch'
  });
...
export default function ContractsListPage() {
  ...
  useEffect(() => {
    async function loadContracts() {
      ...
      try {
        ...
        console.log("📡 Loading contracts from:", `${apiBase}/api/contracts?jurisdiction=${jurisdiction}`);
        ...
        console.log('🔍 Filter debug:', {
          array: raw,
          arrayType: typeof raw,
          isArray: Array.isArray(raw),
          location: 'ContractsListPage loadContracts raw'
        });
  ...
  const results = useMemo(() => {
    ...
    if (cat !== "all") {
      console.log('🔍 Filter debug:', { array: filtered, arrayType: typeof filtered, isArray: Array.isArray(filtered), location: 'ContractsListPage categoryFilter' });
      filtered = ensureArray((filtered || []).filter((i) => i && i.category === cat), "categoryFilter");
    }
    
    if (lang) {
      console.log('🔍 Filter debug:', { array: filtered, arrayType: typeof filtered, isArray: Array.isArray(filtered), location: 'ContractsListPage langFilter' });
