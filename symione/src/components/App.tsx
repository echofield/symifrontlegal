    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <ControlSurface 
                onNavigate={(route) => {
                  ...
                  if (route === 'bond') handleNavigate('bond');
                }}
          ...
          {currentView === 'bond-contract' && selectedContractId && (
            <motion.div
              key="bond-contract"
              initial={{ opacity: 0, y: 6 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {currentView === 'bond-payment' && selectedMilestoneId && (
            <motion.div
              key="bond-payment"
              initial={{ opacity: 0, y: 6 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {currentView === 'bond-settings' && (
            <motion.div
              ...
              transition={{ duration: 0.2, ease: 'linear' }}
            >
              <BondSettingsView onBack={handleBack} />
            </motion.div>
          )}
        </AnimatePresence>
      </main>
