...
export const DOCUMENTS: Document[] = [
  {
    ...
    description:
      "Sécurisez vos missions de conseil, développement ou marketing avec un contrat complet et clair.",
  ...
  },
  {
    ...
    description:
      "Protégez vos oeuvres et vos droits d'auteur pour des projets de design, d'illustration ou de vidéo.",
  ...
  },
  {
    ...
    title: "Contrat SaaS",
    description:
      "Formalisez vos offres logicielles avec des clauses de service, de disponibilité et de support.",
  ...
  },
  {
    ...
    description:
      "Cadrez vos collaborations professionnelles avec une gouvernance claire et des clauses de sortie.",
  ...
  },
  {
    ...
    description:
      "Sécurisez vos recrutements temporaires avec un contrat conforme au droit du travail et aux conventions.",
    tags: ["RH", "CDD", "emploi"],
  },
  {
    id: "contrat-cdi",
    ...
    description:
      "Formalisez une embauche durable avec des clauses adaptées aux postes cadres et non cadres.",
    tags: ["RH", "CDI", "emploi"],
  },
  {
    ...
    description:
      "Protégez vos informations sensibles lors de discussions commerciales ou partenariats stratégiques.",
  ...
  },
  {
    ...
    description:
      "Définissez un cadre légal clair pour la vente de vos produits ou services en ligne.",
  ...
  },
  {
    ...
    description:
      "Organisez la gouvernance de votre société et anticipez les scénarios de sortie des associés.",
  ...
  },
  {
    ...
    description:
      "Attribuez des droits d'utilisation de vos logiciels tout en protégeant votre propriété intellectuelle.",
